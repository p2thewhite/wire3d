...
class Win32KeyMappedIRTest : public ::testing::Test
{
protected:
	...
	Win32KeyMappedIRTest()
		: mWin32KeyMappedIR(&mInputDevice)
	{
	}

	virtual ~Win32KeyMappedIRTest()
	{
	}
...
TEST_F(Win32KeyMappedIRTest, should_map_mouse_Y_axis_to_up_down_axis)
{
...
TEST_F(Win32KeyMappedIRTest, should_map_mouse_X_axis_to_left_right_axis)
{
...
TEST_F(Win32KeyMappedIRTest, should_not_map_forward_backward_axis)
{
	mpWin32InputDataBuffer->SetMouseY(100);
	mpWin32InputDataBuffer->SetMouseX(100);
